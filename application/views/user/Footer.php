  ...
  <script src="<?=base_url();?>template/js/jquery-migrate-3.0.1.min.js"></script>
  ...
  <script src="<?=base_url();?>template/js/jquery.stellar.min.js"></script>
  ...
  <script src="<?=base_url();?>template/js/jquery.animateNumber.min.js"></script>
  <script src="<?=base_url();?>template/js/scrollax.min.js"></script>
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
  <script src="<?=base_url();?>template/js/google-map.js"></script>
